import { Injectable, NotFoundException, UnauthorizedException, BadGatewayException } from '@nestjs/common';
...
export class AuthService implements IAuthService {
  ...
  async login(res: Response, dto: AuthLoginDto): Promise<{ access_token: string }>{
  ...
  async register(res: Response, dto: AuthRegisterDto):  Promise<{ access_token: string }>{
